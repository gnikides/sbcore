...
{       
    ...
    public static function uStrpos($string, $needle, $offset = NULL)
    {
        if (is_null($offset)) {
            $data = explode($needle, $string, 2);
            if (count($data) > 1) {
                return self::uStrlen($data[0]);
            }       
            return false;
        } else {
            if (!is_int($offset)) {
            ...
            $string = self::uSubstr($string, $offset);
            
            if (false !== ($position = self::uStrpos($string, $needle))) {
    ...
    public static function uStrrpos($string, $needle, $offset = NULL)
    {
        if (is_null($offset)) {
            ...
            $string = self::uSubstr($string, $offset);          
            if (false !== ($position = self::uStrrpos($string, $needle))) {
                return $position + $offset;
            }           
            return false;
        }
    ...
    public static function uSubstr($string, $offset, $length = null)
    {
        // generates E_NOTICE
    ...
    public static function uStrtolower($string)
    {
        ...
        return self::fromUnicode($unicode);
    }
    
    public static function uStrtoupper($string)
    {
    ...
    public static function fromUnicode($data)
    {
        ob_start();
